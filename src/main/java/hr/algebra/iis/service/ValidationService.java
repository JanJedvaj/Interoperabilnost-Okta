...
public class ValidationService {
    ...
    public List<String> validateXml(String xmlContent) {
        ...
        try {
            ...
            ClassPathResource xsdResource = new ClassPathResource("schemas/application.xsd");
    ...
    public List<String> validateJson(String jsonContent) {
        ...
        try {
            ...
            ClassPathResource schemaResource = new ClassPathResource("schemas/application-schema.json");
